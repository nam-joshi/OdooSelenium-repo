...
#     login_button.click()
#     time.sleep(5)
#     home_menu_button = driver.find_element(By.CSS_SELECTOR, "button[title='Home Menu']")
#     home_menu_button.click()
#     time.sleep(5)
#     fleet_menu = driver.find_element(By.XPATH, "//div[@role='menu']//a[contains(text(), 'Fleet')]")
#     fleet_menu.click()
#     time.sleep(5)
#     new_button = driver.find_element(By.CSS_SELECTOR, "button.btn.btn-primary.o-kanban-button-new")
#     new_button.click()
#     time.sleep(5)
#     model_input = driver.find_element(By.XPATH, "//div[@name='model_id']//input[@type='text']")
#     model_input.click()
#     time.sleep(2)
...
#     time.sleep(3)
#     driver_input = driver.find_element(By.XPATH, "//div[@name='driver_id']//input[@class='o_input ui-autocomplete-input']")
#     driver_input.click()
#     driver_input.send_keys(Keys.ARROW_DOWN)
#     driver_input.send_keys(Keys.ENTER)
#     time.sleep(3)
#     save_button = driver.find_element(By.XPATH, "//button[contains(@class, 'o_form_button_save') and text()[normalize-space()='Save']]")
#     save_button.click()
#     time.sleep(3)
#     fleet_button = driver.find_element(By.XPATH, "//a[contains(@class, 'dropdown-item') and contains(text(), 'Fleet')]")
#     fleet_button.click()
#     time.sleep(3)
